...
The address is 127.0.0.1 and the port is 8000
...
The client gets input from the read function, i.e. terminal input
4. How does the client program end? How can you tell that in the code?
It ends when the input from the read function is of 1 or less length, i.e. the user enters enter
*/
#include <arpa/inet.h>
#include <stdio.h>
#include <stdlib.h>
